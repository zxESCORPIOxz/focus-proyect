...
const ContenidoCursos = () => {
  ...
  const { cursoSeleccionado,guardarCursoSeleccionado } = useCursoContext();
                              ...
                              <div className="relative group">
                                {curso.estado_curso === "Activo" ? (
                                  <button
                                    ...
                                    onClick={() => desactivarHandlerPopup(curso.id_curso)}
                                  >
                                  ...
                                  <button
                                    ...
                                    onClick={() => activarHandlerPopup(curso.id_curso)}
                                  >
                                    <FaUnlock className="h-5 w-5" />
                                  </button>
                                )}
                                <span className="absolute -top-5 left-1/2 transform -translate-x-1/2 px-2 py-1 text-xs text-white bg-gray-700 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity">
                                  {curso.estado_curso === "Activo" ? "Desactivar" : "Activar"}
                                </span>
                              </div>
