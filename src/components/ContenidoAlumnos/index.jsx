...
const ContenidoAlumnos = () => {
  const [isFormOpen, setIsFormOpen] = useState(false); // Estado para alternar entre la tabla y el formulario
  ...
  return (
    <div className="flex-1 p-6">
      ...
      <main className="bg-white py-2 px-4 rounded-lg shadow">
        <div className="h-[calc(92vh-160px)]  overflow-auto mb-0"> 
          {isFormOpen ? (
              ...
              <div className="flex gap-4 mb-6">
                ...
                <div className="mt-6">
                  <button
                    ...
                    onClick={() => setIsFormOpen(true)} // Cambia a true para mostrar el formulario
                  >
                    Nuevo Alumno
                  </button>
                </div>
