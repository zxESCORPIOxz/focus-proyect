...
const RegistroAlumno = ({  botonTexto,onFormValidation,onSuccess  }) => {
  ...
  return (
    <>
      <div className="bg-white rounded-lg shadow-lg p-6 w-full mx-auto max-w-full sm:max-w-lg md:max-w-5xl">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-blue-600">Paso 2: Registrar Alumno</h1>
        ...
        <div className="space-y-4 mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-blue-600">Datos Personales</h2>
