export const listarAlumnosAsistencia = async (token, id_curso, fecha) => {
    try {
      const response = await fetch(
        "https://ll6aenqwm9.execute-api.us-east-1.amazonaws.com/service/lambda-21-ListarAlumnosAsistencia",
        {
          method: "POST",
          headers: {
      ...
      if (data.status !== "SUCCESS") {
        return {
          status: "FAILED",
          message: data.message || "Error al listar los alumnos para la asistencia.",
        };
      }
